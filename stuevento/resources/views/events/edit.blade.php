                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('events.update', $event->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="location" type="text" class="form-control @error('location') is-invalid @enderror" name="location" value="{{ $event->location }}" required autocomplete="location">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="date" type="datetime-local" class="form-control @error('date') is-invalid @enderror" name="date" value="{{ date('Y-m-d\TH:i:s', strtotime($event->date)) }}" required autocomplete="date">
